...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001698487847 -1002440473319').split()]
...
reqst_channel = environ.get('-1002357077192')
...
# Others
IS_VERIFY = is_enabled((environ.get('IS_VERIFY', 'Trur')), True)
